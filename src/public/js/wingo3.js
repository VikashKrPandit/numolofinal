    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
                      <div data-v-a9660e98="" class="van-empty">
                          ...
                          <p class="van-empty__description">No data20</p>
                      </div>
                      `
    );
  }
    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
                      <div data-v-a9660e98="" class="van-empty">
                          ...
                          <p class="van-empty__description">No data21</p>
                      </div>
                      `
    );
  }
    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
        <div data-v-a9660e98="" class="van-empty">
          ...
          <p class="van-empty__description">No data22</p>
        </div>
      `
    );
  }
    ...
    return $(`.game-list .con-box:eq(${x}) #history-order`).html(
      `
                      <div data-v-a9660e98="" class="van-empty">
                          ...
                          <p class="van-empty__description">No Data23</p>
                      </div>
                      `
    );
  }
