    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
                    <div data-v-a9660e98="" class="van-empty">
                        ...
                        <p class="van-empty__description">No data11</p>
                    </div>
                    `
    );
  }
...
function alertBox(join, addText) {
  ...
  switch (join) {
    case "x":
      ...
      break;
    case "t":
      selectCss("colorviolet", "rgb(255 197 17)", addText);
      break;
    case "d":
    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
                    <div data-v-a9660e98="" class="van-empty">
                        ...
                        <p class="van-empty__description">No data12</p>
                    </div>
                    `
    );
  }
    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
        <div data-v-a9660e98="" class="van-empty">
          ...
          <p class="van-empty__description">No data13</p>
        </div>
      `
    );
  }
    ...
    return $(`.game-list .con-box:eq(${x}) #history-order`).html(
      `
                    <div data-v-a9660e98="" class="van-empty">
                        ...
                        <p class="van-empty__description">No Data15</p>
                    </div>
                    `
    );
  }
