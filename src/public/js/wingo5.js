    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
                      <div data-v-a9660e98="" class="van-empty">
                          ...
                          <p class="van-empty__description">No Data30</p>
                      </div>
                      `
    );
  }
    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
                      <div data-v-a9660e98="" class="van-empty">
                          ...
                          <p class="van-empty__description">No Data31</p>
                      </div>
                      `
    );
  }
    ...
    return $(`.game-list .con-box:eq(${x}) .hb`).html(
      `
        <div data-v-a9660e98="" class="van-empty">
          ...
          <p class="van-empty__description">No data33</p>
        </div>
      `
    );
  }
    ...
    return $(`.game-list .con-box:eq(${x}) #history-order`).html(
      `
                      <div data-v-a9660e98="" class="van-empty">
                          ...
                          <p class="van-empty__description">No Data35</p>
                      </div>
                      `
    );
  }
